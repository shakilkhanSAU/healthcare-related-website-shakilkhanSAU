            ...
            <Container>
                <Row>
                    <Col xs={12} md={4} className="footer-title">
                        <h2>CosGrove</h2>
                        <p>Discover better health & wellness by using our doctors. The requested records directly to fuctional qualified doctors the day before or the day of the appointment</p>
                    </Col>
